...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "fr.opensagres.eclipse.forms.samples"; //$NON-NLS-1$

	// The shared instance
	private static Activator plugin;

	private ServiceRegistration<IPersonService> registration;
...
//				.registerService(IPersonService.class, new PersonService(),
//						null);
	}
