 ...
 */
package fr.opensagres.eclipse.forms.samples.services.pagination;
 ...
 */
public class Sort implements Iterable<fr.opensagres.eclipse.forms.samples.services.pagination.Sort.Order>, Serializable {
	...
	public String toString() {
		...
		return orders.toString();//StringUtils.collectionToCommaDelimitedString(orders);
	}
