...
public class ScrolledPropertiesBlock extends MasterDetailsBlock {
	...
	protected void createMasterPart(final IManagedForm managedForm,
		...
		viewer.setContentProvider(ReportProcessorTypeContentProvider.getInstance());
		viewer.setLabelProvider(ReportProcessorTypeLabelProvider.getInstance());
		viewer.setInput(((ReportingEditorInput) page.getEditor()
				.getEditorInput()).getEntry().getModule().getProcessors()
				.getProcessorTypes());
	}
