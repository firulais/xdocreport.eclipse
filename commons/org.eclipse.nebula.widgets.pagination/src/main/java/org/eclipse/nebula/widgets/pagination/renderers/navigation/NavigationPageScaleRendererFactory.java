 ...
 * 
 */
public class NavigationPageScaleRendererFactory implements CompositeRendererFactory {

	private static final CompositeRendererFactory FACTORY = new NavigationPageScaleRendererFactory();
	...
	public Composite createComposite(
			Composite parent, int style, PaginationController controller) {
