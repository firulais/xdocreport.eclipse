...
public class GreenGraphicsPageNavigationConfigurator implements GraphicsPageNavigationConfigurator {

	private final static GraphicsPageNavigationConfigurator INSTANCE = new GreenGraphicsPageNavigationConfigurator();
