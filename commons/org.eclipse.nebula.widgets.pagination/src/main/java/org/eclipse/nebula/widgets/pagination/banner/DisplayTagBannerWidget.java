...
public class DisplayTagBannerWidget extends Composite implements
	...
	public DisplayTagBannerWidget(PaginationController controller,
	...
	private void createLeftContainer() {
		...
		addHyperlinkListener(firstLink);
		...
		addHyperlinkListener(previousLink);
	}
