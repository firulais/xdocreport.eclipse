 ...
 *******************************************************************************/
package org.eclipse.nebula.widgets.pagination.example.springdata.table.lazy;
...
public class LazyPageTableExample {
	...
	public static void main(String[] args) {
		...
		// new PageLoaderList(items);
		final PageableController controller = new SpringDataPageableController(
				pageSize);// new PageableController(pageSize);
