...
public class PShelf extends Canvas {
    ...
    {
    	// [az] SWT.RIGHT_TO_LEFT doesn't exist with RAP
        //int mask = SWT.LEFT_TO_RIGHT | SWT.RIGHT_TO_LEFT | SWT.BORDER | SWT.SIMPLE;
    	int mask = SWT.LEFT_TO_RIGHT | SWT.BORDER | SWT.SIMPLE;
	...
	public PShelf(Composite parent, int style) {
		...
		// [az] addMouseTrackListener+addMouseMoveListener doesn't exist with RAP
...
//            }});
    ...
    public void addSelectionListener(SelectionListener listener) {
        checkWidget ();
        // [az] use RAP SelectionEvent (like Combo)
