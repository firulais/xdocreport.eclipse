...
public class ClientsPage extends ReportingFormPage {
	...
	public ClientsPage(ReportingFormEditor editor) {
		super(editor, ID, Messages.ProjectFormEditor_ClientsPage_title);
	}
