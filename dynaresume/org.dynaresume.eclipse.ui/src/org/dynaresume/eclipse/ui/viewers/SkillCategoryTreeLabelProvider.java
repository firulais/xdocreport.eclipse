...
public class SkillCategoryTreeLabelProvider extends LabelProvider {

	private static SkillCategoryTreeLabelProvider instance;

	public static SkillCategoryTreeLabelProvider getInstance() {
		synchronized (SkillCategoryTreeLabelProvider.class) {
			if (instance == null) {
				instance = new SkillCategoryTreeLabelProvider();
			}
			return instance;
		}
	}
