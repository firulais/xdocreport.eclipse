...
import org.dynaresume.admin.eclipse.ui.graphics.skill.editor.model.SkillTreeNode;
...
public class SkillTreeEditorPaletteFactory {
	...
	private static PaletteContainer createComponentsDrawer() {
		...
		CombinedTemplateCreationEntry combined = new CombinedTemplateCreationEntry(
				...
				SkillTreeNode.class,
				new SimpleFactory(SkillTreeNode.class),
