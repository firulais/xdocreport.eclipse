...
import org.dynaresume.admin.eclipse.ui.graphics.skillOLD.editors.commands.OrphanChildCommand;
 ...
 * @author Daniel Lee
 */
public class SkillContainerEditPolicy extends ContainerEditPolicy {
	...
	protected Command getOrphanChildrenCommand(GroupRequest request) {
		...
		for (int i = 0; i < parts.size(); i++) {
			...
			orphan.setChild((ConnectableNode) ((EditPart) parts.get(i)).getModel());
			orphan.setParent((SkillsDiagram) getHost().getModel());
			result.add(orphan);
		}
