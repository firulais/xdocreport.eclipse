...
public class SearchGroupDialog extends SearchDialog
		implements
		IPageLoader<SpringDataPageableController, Page<org.dynaresume.domain.core.Group>> {
	...
	public Page<org.dynaresume.domain.core.Group> loadPage(
			SpringDataPageableController controller) {
		return groupService.findByName(labelCriteria, controller);
	}
